...
public class Recipe implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(strMeal, recipe.strMeal) && Objects.equals(strArea,recipe.strArea) && Objects.equals(strCategory, recipe.strCategory) && Objects.equals(strYoutube, recipe.strYoutube);
    }

    @Override
    public int hashCode() {
        return Objects.hash(strMeal, strArea, strCategory, strYoutube);
    }

    public static Recipe getSampleRecipe() {
        Recipe sample = new Recipe();
        sample.setStrMeal("Not so long title sample");
        sample.setStrArea("Area short");
        return sample;
    }

    public static void filterRecipes(List<Recipe> recipeList) {
        for (int i = 0; i < recipeList.size(); i++) {
            if (recipeList.get(i).getStrMeal().equals(Constants.REMOVED_RECIPE_STR_MEAL)) {
                recipeList.remove(i);
                i--;
            }
        }
    ...
    // Parcelable: Costruttore da Parcel
    ...
    public void readFromParcel(Parcel source) {
        this.idMeal = source.readLong();
        this.strMeal = source.readString();
        this.strDrinkAlternate = source.readString();
        ...
        this.strMeasure1 = source.readString();
        this.strMeasure2 = source.readString();
        this.strMeasure3 = source.readString();
        this.strMeasure4 = source.readString();
        this.strMeasure5 = source.readString();
        this.strMeasure6 = source.readString();
        this.strMeasure7 = source.readString();
        this.strMeasure8 = source.readString();
        this.strMeasure9 = source.readString();
        this.strMeasure10 = source.readString();
        this.strMeasure11 = source.readString();
        this.strMeasure12 = source.readString();
        this.strMeasure13 = source.readString();
        this.strMeasure14 = source.readString();
        this.strMeasure15 = source.readString();
        this.strMeasure16 = source.readString();
        this.strMeasure17 = source.readString();
        this.strMeasure18 = source.readString();
        this.strMeasure19 = source.readString();
        this.strMeasure20 = source.readString();
        this.strSource = source.readString();
        this.strImageSource = source.readString();
        this.strCreativeCommonsConfirmed = source.readString();
        this.dateModified = source.readString();
